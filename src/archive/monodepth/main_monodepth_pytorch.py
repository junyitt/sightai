...
from monodepth.utils import get_model, to_device, prepare_dataloader
...
class Model:
    ...
    def retest(self, image_file, data_dir=""):
        args = self.args
        # self.n_img, self.loader = prepare_dataloader(data_dir, args.mode, args.augment_parameters,
        #                                              args.do_augmentation, args.batch_size,
        #                                              (args.input_height, args.input_width),
        #                                              args.num_workers)
        # self.test()
        ...
        with torch.no_grad():
            ...
            trans2 = transforms.Resize((args.input_height, args.input_width))
            data = trans2(img)
            data = trans1(data)
